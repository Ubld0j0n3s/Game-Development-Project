...
public class Tank {
	...
	public static int homeTankX = 6;
	public static int homeTankY = 6;
	public static int homeTank2X = 6;
	public static int homeTank2Y = 6;
	...
	// draw the tanks to the game frame
	...
	void move() {
		...
		switch (direction) {
			case L:
				...
				break;
			case U:
				// Adjusted the condition to prevent going above the tanks remaining display
				if (y - speedY > 70)
					y -= speedY;
				break;
			case R:
	...
	// method determines if the current tank is within a certain proximity to the
	// player tank
	// by checking the intersection of bounding boxes. This can be used for
	// implementing logic
	// related to the behavior of the tank when it is close to the player tank.
